...
const TokenContractAddress = "0xd68CCa05D2b750329A125f2CBc00b97e3FbF53D4";
    ...
    async mint(tokenURI) {
        ...
        try {
            ...
            const tx = await this.contract.mint(tokenURI, {
                value: ethers.parseEther("0.001") // Adjust the value according to your mintPrice in the contract
            });
